...
<div class="ding">
    ...
    <div class="tian1">
        <div class="jian3">
            <i class="el-icon-s-unfold"></i>教师列表
        </div>
        <div class="tian2" @click="dialogFormVisible = true">
            <i class="el-icon-plus"></i><span>新增教师</span>
        </div>
        ...
        <div class="tian4">
            <el-table ref="multipleTable" :header-cell-style="rowClass" :cell-style="cellStyle" :data="showTable" tooltip-effect="dark" style="width: 100%;" @selection-change='selectRow'>
                ...
                <el-table-column prop="name" label="教师名称" width="140" style="text-align: center;">
                </el-table-column>
