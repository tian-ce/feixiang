...
<div class="ding">
    ...
    <el-dialog title="新增教育头条" :visible.sync="dialogFormVisible">
        <el-form :model="form">
            <el-form-item label="教育头条名称" :label-width="formLabelWidth">
    ...
    <el-dialog title="编辑教育头条" :visible.sync="editFormVisible">
        <el-form :model="form">
