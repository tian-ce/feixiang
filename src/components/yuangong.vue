...
<div class="ding">
    ...
    <div class="tian1">
        <div class="jian3">
            <i class="el-icon-s-unfold"></i>员工列表
        </div>
        <div class="tian2" @click="dialogFormVisible = true">
            <i class="el-icon-plus"></i><span>新增员工</span>
        </div>
        ...
        <div class="tian4">
            <el-table ref="multipleTable" :header-cell-style="rowClass" :cell-style="cellStyle" :data="showTable" tooltip-effect="dark" style="width: 100%;" @selection-change='selectRow'>
                ...
                <el-table-column prop="name" label="员工名称" width="140" style="text-align: center;">
                </el-table-column>
                ...
                <el-table-column label="操作" width="250">
                    <template slot-scope="scope">
                        ...
                        <el-button type="text" size="small" @click.prevent="delData()">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
